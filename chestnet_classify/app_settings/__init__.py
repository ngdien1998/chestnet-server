settings = {
    'image_source_path': r'D:\STUDY\KLTN\chestnet-server\chestnet_classify\client\images',
    'return_image_path': r'D:\STUDY\KLTN\chestnet-server\chestnet_classify\client',
    'data_desc_path': r'D:\STUDY\KLTN\chestnet-server\chestnet_classify\dataData_Entry_2017.csv',
    'models': {
        'densenet121': {
            'name': 'DenseNet121',
            'weights': r'D:\STUDY\KLTN\chestnet-server\weights-densenet121.h5',
        ...
        'mobilenet': {
            'name': 'MobileNet',
            'weights': r'D:\STUDY\KLTN\chestnet-server\weights-mobilenet.h5',
        ...
        'vgg16': {
            'name': 'VGG16',
            'weights': r'D:\STUDY\KLTN\chestnet-server\weights-vgg16.h5',
